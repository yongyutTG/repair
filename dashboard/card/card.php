...
<nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <?php
		  $card_type = isset($_GET['type']) ? addslashes($_GET['type']) : '';
		  if($card_type != ''){
			  $gettype_detail = $getdata->my_sql_query(NULL,"card_type","ctype_key='".$card_type."'");
		  ...
		  $gettype = $getdata->my_sql_select(NULL,"card_type","ctype_status='1' ORDER BY ctype_insert");
            ...
            while($showtype = mysqli_fetch_object($gettype)){
  ...
  <?php
   if($card_type != ''){
	   $getcard_count = $getdata->my_sql_show_rows("card_info","card_status = '".$card_type."' ORDER BY card_insert");
  }else{
  ...
  <?php
  if($card_type != ''){
	   $getcard = $getdata->my_sql_select(NULL,"card_info","card_status = '".$card_type."' ORDER BY card_insert");
  }else{
