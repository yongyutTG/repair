...
<div class="panel panel-primary">
 <div class="panel-heading">
  ...
  <tr>
    ...
    <td colspan="2" rowspan="4" style="text-align:center"> สแกนเพื่อตรวจสอบสถานะ<br/><?php echo '<img src="'.$PNG_WEB_DIR.basename($filename).'" /><br/>'; echo @url().$card_detail->card_code;  ?></td>
    </tr>
  <tr>
