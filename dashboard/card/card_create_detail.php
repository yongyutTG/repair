...
if(isset($_POST['save_item'])){
	if(addslashes($_POST['item_name']) != NULL && addslashes($_POST['item_note']) != NULL){
		...
		$getdata->my_sql_insert("card_item","item_key='".$item_key."',card_key='".$card_detail->card_key."',item_number='".INumber()."',item_name='".addslashes($_POST['item_name'])."',item_note='".@addslashes($_POST['item_note'])."',item_price_aprox='".@$price_aprox."'");
		updateItem();
