...
$db = new clear_db();
if(!$db->my_sql_connect(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_NAME)){
...
$user_key = isset($_SESSION['ukey']) ? $_SESSION['ukey'] : '';
$userdata = $getdata->my_sql_query(NULL,"user","user_key='".$user_key."'");
...
$_SESSION['lang'] = $lang;
if($lang != ''){
	require_once("language/".$lang."/site.lang");
	require_once("language/".$lang."/menu.lang");
}else{
	require_once("language/th/site.lang");
	require_once("language/th/menu.lang");
	$_SESSION['lang'] = 'th';
}
?>
<body>
