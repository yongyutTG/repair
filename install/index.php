...
if(DB_NAME != '' && @$connect && @mysqli_select_db($connect, DB_NAME)){
...
if(isset($_POST['save_database'])){
	@$connect = mysqli_connect(addslashes($_POST['host_name']), addslashes($_POST['user_name']), addslashes($_POST['password']));
	if(!@$connect){
...
@mysqli_select_db($connect, addslashes($_POST['db_name']));
if(mysqli_error($connect)){
	@mysqli_query($connect, "CREATE DATABASE ".addslashes($_POST['db_name']));
	@mysqli_select_db($connect, addslashes($_POST['db_name']));
